...
public class FileOutput_ {
	...
	public static void main(String[] args) {
		...
		file =new File("sevneteen/svt.txt");//seventeen폴더안 파일저장
		file =new File("sevneteen\\svt.txt");//큰따옴표안 역슬래시는 특수문자
		...
		file=new File(path,"svt.txt");//path경로와 파일명 결합
		
		//내 프로젝트가 아닌 특정위치에 저장
		file=new File("D:/aaa.txt");
		
		//특정폴더 지정->경로만 있는 File객체 생성
